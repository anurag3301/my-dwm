...
/* staticstatus */
static const int statmonval = 0 ^ monitor;
...
static const Rule rules[] = {
  ...
  { "discord",         NULL,       NULL,       1 << 7,         0,     0,     0,       0^monitor},
  { "steam",           "steam",    "Steam",    1 << 6,         0,     0,     0,       0^monitor},
  { "Spotify",         NULL,       NULL,       1 << 8,         0,     0,     0,       1^monitor},
  { "kdeconnect.app",  NULL,       NULL,       1 << 7,         0,     0,     0,       1^monitor},
  { "thunderbird",     NULL,       NULL,       1 << 6,         0,     0,     0,       1^monitor},
  { "Com.github.xournalpp.xournalpp",NULL,NULL,1 << 8,         0,     0,     0,       0^monitor},
  { "kitty",           NULL,       NULL,        0,             0,     1,     0,       0^monitor},
};
